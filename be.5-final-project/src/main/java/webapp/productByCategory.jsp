...
pageContext.setAttribute("categoryId", categoryDao.getCategoryById(categoryId));

List<Product> categoryProducts = productDao.getProductsByCategoryId(categoryId);
					...
					<ul class="navbar-nav  ">
						...
						<c:forEach items="${categories}" var="category">
							<li class="nav-item"><a class="nav-link"
								href="productByCategory.jsp?categoryId=${category.id}"> ${category.name}</a></li>
						</c:forEach>
