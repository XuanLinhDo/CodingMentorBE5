		...
		<div class="container container-bg">
			<div class="row">
				...
				<div class="col-md-6 col-lg-4 px-0">
					<form action="RegistrationControlller"
						method="post">
						<div>
						...
						<div class="small-inputs">
							...
							<label for="Eat">Eat</label><br> <input type="checkbox"
								id="Sleep" name="hobbies[]" value="Sleep"> <label
								for="Sleep">Sleep</label><br> <input type="checkbox"
								id="Dance" name="hobbies[]" value="Dance"> <label
								for="Dance">Dance</label><br>
						</div>
						<div class="d-flex">
