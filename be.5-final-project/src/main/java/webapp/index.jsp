...
<body>
			...
			<nav class="navbar navbar-expand-lg custom_nav-container ">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav  ">
						...
						<c:forEach items="${categories}" var="category">
							<li class="nav-item"><a class="nav-link"
								href="HomeController?categoryId=${category.id}">
									${category.name}</a></li>
						</c:forEach>
					...
					<div class="user_option">
						<a href="Login"> <i class="fa fa-user" aria-hidden="true"></i> <span>
								Login </span>
						</a> <a href=""> <i class="fa fa-shopping-bag" aria-hidden="true"></i>
						</a>

						<div class="col-md-6 col-lg-5 px-0">
							<form class="form-inline" action="HomeController">
								<div class="input">
	...
	<section class="shop_section layout_padding">
		<div class="container">
			...
			<div class="row">
				<c:forEach items="${products}" var="product">
					<div class="col-sm-6 col-md-4 col-lg-3">
						<div class="box">
							<a href="ProductController?productId=${product.id}">
								<div class="img-box">
			...
			<div class="btn-box">
				<a href="HomeController?action=SHOW_ALL"> View All Products </a>
			</div>
		</div>
	</section>
