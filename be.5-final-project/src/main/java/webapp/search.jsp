...
pageContext.setAttribute("productName", productDao.getProductByName(productName));
%>
<head>
<!-- Basic -->
<meta charset="utf-8" />
...
<body>
					...
					<ul class="navbar-nav  ">
						...
						<c:forEach items="${categories}" var="category">
							<li class="nav-item"><a class="nav-link"
								href="productByCategory.jsp?categoryId=${category.id}">
									${category.name}</a></li>
						</c:forEach>
	...
	<section class="shop_section layout_padding">
		<div class="container">
			...
			<div class="row">
				<c:forEach items="${productName}" var="products">
					<div class="col-sm-6 col-md-4 col-lg-3">
						<div class="box">
							<a href="product-detail.jsp?productId=${products.id}">
								<div class="img-box">
